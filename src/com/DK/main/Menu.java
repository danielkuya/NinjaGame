...
public class Menu {
	...
	public void render (Graphics g) {
		...
		g.drawString("NinjaMaster", Window.WIDTH / 5, Window.HEIGHT / 5);
		...
		if (pause) {
			...
			g.drawString("Novo Jogo", Window.WIDTH / 5, Window.HEIGHT / 3);
		}

		g.setColor(getColor(1));
		g.drawString("Carregar Jogo", Window.WIDTH / 5, (int)(Window.HEIGHT / 2.3));

		g.setColor(getColor(2));
		g.drawString("Sair", Window.WIDTH / 5, (int)(Window.HEIGHT / 1.85));
	}
}