...
public class Iruka extends Entity {
	...
	public Iruka (double x, double y) {
		...
		phrases[0] = "Powered by DK.";
		phrases[1] = "bkft240@gmail.com";
		phrases[2] = "My name is Umino Iruka.";
		phrases[3] = "https://github.com/danielkuya";
		phrases[4] = "Programmed by Daniel Soares.";
		phrases[5] = "He is a Brazilian student developer.";
