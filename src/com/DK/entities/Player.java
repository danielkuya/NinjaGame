...
import com.DK.graphics.Spritesheet;
import com.DK.main.Game;
import com.DK.main.NewerSound;
import com.DK.main.Window;
import com.DK.world.Camera;
import com.DK.world.World;
...
public class Player extends Entity {
	...
	public void exibirPontuacao(int pontuacao) {
		  ...
		  if (pontuacao < 0) {
			...
			JOptionPane.showMessageDialog(null, "Pontuação final: " + pontuacao);
			System.out.println("Banco Render \n Pontos: " + pontuacao + "Parabéns, você foi muito bem");
		}
